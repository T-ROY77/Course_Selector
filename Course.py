...
course_array = [
    ...
    Course("168", "CS", "T", [13.3, 14.45], 3.0),
    ...
    Course("20", "BIOL", "T", [9.3, 10.45], 2.5),
    Course("21", "BIOL", "T", [10.3, 11.45], 2.5),
    Course("30", "BIOL", "M", [7.3, 10.45], 2.5),
    Course("31", "BIOL", "M", [9, 10.15], 2.5),
    Course("54", "BIOL", "T", [10.3, 11.45], 2.5),
    Course("55", "BIOL", "T", [10.3, 11.45], 2.5),
    ...
    Course("120D", "HIST", "T", [10.00, 11.30], 2.5),
